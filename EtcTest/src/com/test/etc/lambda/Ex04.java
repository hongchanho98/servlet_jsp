...
public class Ex04 {
	...
	public static void main(String[] args) {
		...
		// 5. Predicate: 매개변수 O, 반환값O, 매개변수를 논리 연산 후 결과 반환, Function 하위 버전
		//	Predicate<T>
		//  BiPredicate<T,U>
		//m1();
		//m2();
	...
	private static void m6() {
		...
		Function<Integer,Boolean> f1 = num -> num>0; // boolean 받은걸
		Function<Boolean,String> f2 = flag -> flag ? "양수":"음수"; // boolean 넣기
		...
		System.out.println(p3.test(6));      // true          true
		System.out.println(p3.test(5));      // false        false
		System.out.println();
		
		Predicate<Integer> p4 = p1.or(p2); // p1 || p2
		System.out.println(p4.test(2)); // true  false
		System.out.println(p4.test(3));// false true
		System.out.println(p4.test(5));// false false
		System.out.println();
		
		Predicate<Integer> p5 = p1.negate(); // !p1
		System.out.println(p5.test(2)); // false
		System.out.println(p5.test(3)); // true
	...
	private static void m5() {
		...
		// 5. Predicate: 매개변수 O, 반환값O, 매개변수를 논리 연산 후 결과 반환, Function 하위 버전
		// - 매개변수의 값을 받아 무언가를 조사한 후 논리값을 반환한다. 무조건 boolean
		// - testXXX()
		...
		System.out.println(bp1.test(5,10));
	...
	private static void m4() {
		...
		// 4. Operator: 매개변수O, 반환값O, 매개변수를 연산 후 결과 반환, Function 하위 버전
		// - 매개변수 값을 받아 연산 처리를 한 후 반환값을 돌려주는 역할
		// - applyXXX()
