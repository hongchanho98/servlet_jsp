...
//		m4();
	...
	private static void m3() {
		...
		try {
			...
			String sql = "select * from tblAddress where seq = 23";
	...
	private static void m2() {
		...
		try {
			...
			String sql = "select name as nick from tblAddress where seq =23";
...
//				String name = rs.getString(1); 인덱스
//				String name = rs.getString("name"); // 라벨
				String name = rs.getString("nick"); // as 처리하면 여기도 바꿔야함
