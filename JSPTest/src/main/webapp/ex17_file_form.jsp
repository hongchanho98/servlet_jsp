...
<body>
	...
	<div class="container">
		...
		<!--
			...
			GET -> 주소창에 텍스트가 다 들어가서
			텍스트 7000자 전송 -> 에러 ->7000B -> 7KB
			파일 업로드 규칙
			1. <form>의 method를 반드시 "POST"를 사용한다.
			2. <input type="file">을 사용한다
			3. <form> 태그에 enctyp="multipart/form-data" 속성을 추가한다.
				- enctype(인코딩 타입: 폼태그가 서버로 데이터를 전송할때 인코딩 방식을 지정)
		...
		<form action="ex17_file_ok.jsp" method="POST" enctype="multipart/form-data">
