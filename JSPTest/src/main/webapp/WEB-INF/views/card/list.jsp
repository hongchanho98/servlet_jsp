...
<body>
   ...
   <div class="container">
      ...
      <c:forEach items="${list}" var="dto" >
         <div class="item">
            <div class="name">
               <div class="korname">${dto.getKorname() }</div>
               <div class="engname">${dto.getEngname() }</div>
            </div>
            <div class="info">
               <div class="info1">
                  <div class="tel">${dto.getTel() }</div>
                  <div class="email">${dto.getEmail() }</div>
               </div>
               <div class="info2">
                  <div class="company">${dto.getCompany() }</div>
                  <div class="position">${dto.getPosition() }</div>
               </div>
            </div>
         </div>
         </c:forEach>
